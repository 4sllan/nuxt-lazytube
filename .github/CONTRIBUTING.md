# Contributing to Nuxt Lazytube

Thank you for considering contributing to **Nuxt Lazytube**!  
...
```text
feat(youtube): add custom thumbnail support
fix(vimeo): resolve iframe loading issue
...
Thank you for helping improve Nuxt Lazytube!
