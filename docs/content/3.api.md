...
Both components emit events that you can listen to:

| Event | Description | Payload |
|-------|-------------|---------|
| `loaded` | Emitted when the iframe is loaded | `iframe` element |
| `playing` | Emitted when video starts playing | Video ID |
| `paused` | Emitted when video is paused | Video ID |
| `ended` | Emitted when video ends | Video ID |
