...
describe('Utils', () => {
  ...
  describe('getYoutubeThumbnail', () => {
    ...
    it('should return high quality thumbnail', () => {
      expect(getYoutubeThumbnail('dQw4w9WgXcQ', 'high')).toBe(
        'https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg'
      );
    });

    it('should return standard quality thumbnail', () => {
      expect(getYoutubeThumbnail('dQw4w9WgXcQ', 'standard')).toBe(
  ...
  describe('getVimeoThumbnail', () => {
    ...
    it('should return default quality thumbnail', () => {
      expect(getVimeoThumbnail('123456789', 'default')).toBe(
        'https://i.vimeocdn.com/video/123456789_200x150.jpg'
      );
    });

    it('should return medium quality thumbnail', () => {
      expect(getVimeoThumbnail('123456789', 'medium')).toBe(
        'https://i.vimeocdn.com/video/123456789_295x166.jpg'
      );
    });

    it('should return high quality thumbnail', () => {
      expect(getVimeoThumbnail('123456789', 'high')).toBe(
        'https://i.vimeocdn.com/video/123456789_640x360.jpg'
      );
    });

    it('should return standard quality thumbnail', () => {
      expect(getVimeoThumbnail('123456789', 'standard')).toBe(
        'https://i.vimeocdn.com/video/123456789_960x540.jpg'
      );
    });

    it('should return maxres quality thumbnail', () => {
      expect(getVimeoThumbnail('123456789', 'maxres')).toBe(
        'https://i.vimeocdn.com/video/123456789_1280x720.jpg'
      );
    });
